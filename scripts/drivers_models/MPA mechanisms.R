...
hist(phylo_div_post$phylo_entropy)
...
hist(benthic_PC1_post$PC1_Benthic)
...
hist(benthic_PC2_post$PC2_Benthic)
...
hist(trophic_PC1_post$PC1_Trophic)
...
hist(trophic_PC2_post$PC2_Trophic)
...
model_outputs <- data.frame(MPA_post, tax_div_post, fun_div_post, phylo_div_post,
                            ...
                            Taxo_PC1_post, Taxo_PC1_post)

saveRDS(model_outputs, "outputs/MPA_mechanism_effects_V2.rds")
model_outputs <- read_rds("outputs/MPA_mechanism_effects_V2.rds")
